...
const GamePage = ({ isOpen, setIsOpen }) => {
  ...
  const handleChooseNumberOfCards = (e) => {
    dispatch(setNumberOfCards(e));
    dispatch(initGame(e));
  };
        ...
        <div className="font-bold uppercase">
          ...
          <div className="flex justify-between">
            <button
              ...
              onClick={() => handleChooseNumberOfCards(8)}
            >
              16
            </button>
            <button
              className="hover:cursor-pointer"
              onClick={() => handleChooseNumberOfCards(16)}
            >
              32
            </button>
            <button
              className="hover:cursor-pointer"
              onClick={() => handleChooseNumberOfCards(32)}
            >
              64
            </button>
          </div>
          ...
          <div className="flex flex-col gap-5">
            ...
            {/* <div>
              <button
                ...
                type="button"
                className="bg-[#14366f] text-white py-2 px-3 rounded-2xl hover:shadow-md hover:cursor-pointer w-full"
              >
                Exit
              </button>
            </div> */}
